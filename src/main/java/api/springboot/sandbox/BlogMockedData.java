...
public class BlogMockedData {
    ...
    //Singleton Pattern : call with getInstance()
    ...
    // delete blog by id
    //delete() method removes the item from the blog list outside the for-loop, 
    //this is to avoid java.util.ConcurrentModificationException.
